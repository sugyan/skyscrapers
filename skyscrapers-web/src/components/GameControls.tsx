...
export function GameControls({
  ...
  return (
    <div className="flex gap-3 justify-center items-center my-4">
      <button className={btnClass} onClick={onReset}>Reset</button>
      <button className={btnClass} onClick={onCheck}>Check</button>
      <button className={btnClass} onClick={onNewPuzzle}>New Puzzle</button>
      {completed && (
