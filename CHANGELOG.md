...
## [v0.1.4](https://github.com/sugyan/skyscrapers/compare/skyscrapers-tauri/v0.1.3...skyscrapers-tauri/v0.1.4) - 2026-07-28
...
- Fix `cargo clippy --all-targets` on stable and enforce clippy/fmt in CI by @sugyan in https://github.com/sugyan/skyscrapers/pull/76
- Share the app shell between web and Tauri via `<PuzzleApp>` by @sugyan in https://github.com/sugyan/skyscrapers/pull/77
- Add lint, format and typecheck to the Tauri frontend by @sugyan in https://github.com/sugyan/skyscrapers/pull/78
