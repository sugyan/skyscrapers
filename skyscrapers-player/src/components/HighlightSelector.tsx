...
export function HighlightSelector({
  ...
  const pillBase =
    "flex items-center gap-1.5 px-3 py-2 text-base border rounded-md transition-colors duration-100 touch-manipulation select-none cursor-pointer";
  const pillDefault =
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <span
          className={`w-3.5 h-3.5 rounded-sm border ${swatch}`}
          aria-hidden="true"
        />
